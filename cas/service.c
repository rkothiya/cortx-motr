 ...
 *
 * - @b User: any Motr component or external application using a cas instance by
 *   sending fops to it.
 *
 * <hr>
 ...
 * - B-tree for meta-index is stored in zero BE segment of motr global BE
 ...
 * segment (m0_be_domain_seg_first()) of Motr global BE domain
